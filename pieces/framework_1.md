...
本节具体的描述上三个方面的设计思想和相关的逻辑概念、具体的实现介绍参见[产品设计](https://ndxt.github.io/system_design/product_design.html);
...
数据范围权限采用[参数驱动SQL](https://ndxt.github.io/system_design/technical_design.html#参数驱动sql)来控制。
